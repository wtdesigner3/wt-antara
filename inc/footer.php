                ...
                <div class="row g-5">
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-6 col-6">
                        <div class="single-footer-widget">
                            ...
                            <ul class="list-unstyled text-white text-opacity-75 d-flex flex-column gap-2" style="font-size: 14px;">
                                <li><a href="product-arabica.php" class="text-white text-opacity-75 text-decoration-none hover-gold">Arabica Coffee Beans</a></li>
                                <li><a href="product-robusta.php" class="text-white text-opacity-75 text-decoration-none hover-gold">Robusta Coffee Beans</a></li>
                                <li><a href="product-tea.php" class="text-white text-opacity-75 text-decoration-none hover-gold">Indian Bulk Tea</a></li>
                                <li><a href="product-black-pepper.php" class="text-white text-opacity-75 text-decoration-none hover-gold">Malabar Black Pepper</a></li>
                                <li><a href="product-turmeric.php" class="text-white text-opacity-75 text-decoration-none hover-gold">Alleppey Turmeric</a></li>
                                <li><a href="product-arabica.php" class="text-white text-opacity-75 text-decoration-none hover-gold">Specialty Export Lots</a></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-6">
                        <div class="single-footer-widget">
                            ...
                            <ul class="list-unstyled text-white text-opacity-75 d-flex flex-column gap-2" style="font-size: 14px;">
                                <li><a href="supply-coffee.php" class="text-white text-opacity-75 text-decoration-none hover-gold">Coffee Solutions</a></li>
                                <li><a href="supply-matcha.php" class="text-white text-opacity-75 text-decoration-none hover-gold">Ceremonial Matcha</a></li>
                                <li><a href="supply-sauces.php" class="text-white text-opacity-75 text-decoration-none hover-gold">Sauces &amp; Condiments (Veeba)</a></li>
                                <li><a href="supply-syrups.php" class="text-white text-opacity-75 text-decoration-none hover-gold">Artisanal Barista Syrups</a></li>
                                <li><a href="supply-sugar.php" class="text-white text-opacity-75 text-decoration-none hover-gold">Commercial Sugar Sachets</a></li>
                                <li><a href="supply-green-coffee.php" class="text-white text-opacity-75 text-decoration-none hover-gold">Green Beans for Roasters</a></li>
                            </ul>
                        </div>
                    </div>
