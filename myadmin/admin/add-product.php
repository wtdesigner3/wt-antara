...
if (isset($_POST['add_product'])) {
    ...
    $image = "assets/img/commodities/hero-coffee-beans-banner.jpg"; // default
    ...
    $banner_image = "assets/img/commodities/hero-export-banner.jpg";
    ...
    $badge1_icon = 'assets/img/icons/pillar-2-quality.svg';
    ...
    $badge2_icon = 'assets/img/icons/pillar-3-logistics.svg';
    ...
    $badge3_icon = 'assets/img/icons/partnership-trust.svg';
    ...
    $sql = "INSERT INTO `tbl_product` 
            (`category_id`, `division`, `name`, `slug`, `tagline`, `description`, `image`, `banner_image`, `available_varieties`, `brands`, `specifications`, `packaging`, `moq`, `applications`, `badge1_icon`, `badge1_title`, `badge1_desc`, `badge2_icon`, `badge2_title`, `badge2_desc`, `badge3_icon`, `badge3_title`, `badge3_desc`, `sort`, `status`) 
            VALUES 
            ($cat_id, '$division', '$name', '$slug', '$tagline', '$description', '$image', '$banner_image', '$varieties', '$brands', '$specifications', '$packaging', '$moq', '$applications', '$badge1_icon', '$badge1_title', '$badge1_desc', '$badge2_icon', '$badge2_title', '$badge2_desc', '$badge3_icon', '$badge3_title', '$badge3_desc', $sort, $status)";
    
    if (mysqli_query($conn, $sql)) {
        header("Location: manage-products.php?msg=" . urlencode("Product added successfully!"));
        exit();
    } else {
	...
	<div id="page-container" class="page-sidebar-fixed page-header-fixed show">
		...
		<div id="content" class="content">
			<div class="d-flex align-items-center justify-content-between mb-4">
				<div>
					<h1 class="page-header mb-1" style="font-size: 26px;">Add New Product / Commodity</h1>
					<p class="text-muted mb-0">Create a new item for Export or Restaurant & Café Supplies.</p>
				</div>
						...
						<div class="row g-4">
							<div class="col-md-6">
								...
								<select name="division" class="form-select" required>
									<option value="horeca">Restaurant & Café Supplies (HORECA)</option>
									<option value="export">Export Agricultural Commodities</option>
								</select>
							</div>

							<div class="col-md-6">
								<label class="form-label fw-bold">Product Name <span class="text-danger">*</span></label>
								<input type="text" name="name" class="form-control" placeholder="e.g. Specialty Matcha Premix" required>
							</div>

							<div class="col-md-6">
								<label class="form-label fw-bold">URL Slug</label>
								<input type="text" name="slug" class="form-control" placeholder="e.g. supply-matcha-premix (auto-generated if left blank)">
							</div>

							<div class="col-md-6">
								<label class="form-label fw-bold">Tagline / Subheading (Optional)</label>
								<input type="text" name="tagline" class="form-control" placeholder="e.g. Culinary Grade High-Yield Premix for Cafés (Leave blank to hide)">
							...
							<div class="col-12">
								...
								<textarea name="description" id="editor_product_desc" class="form-control ckeditor" rows="6" placeholder="Detailed product description and supply value proposition... (Leave blank to hide)"></textarea>
							...
							<div class="col-md-6">
								...
								<input type="text" name="available_varieties" class="form-control" placeholder="e.g. Grade A, Grade B, Peaberry (Leave blank to hide block)">
							...
							<div class="col-md-6">
								...
								<input type="text" name="brands" class="form-control" value="Antara Globale Sourced" placeholder="e.g. Veeba / Custom Brands on Request (Leave blank to hide block)">
							...
							<div class="col-12">
								...
								<textarea name="specifications" id="editor_product_specs" class="form-control ckeditor" rows="5" placeholder="e.g. Moisture: <= 12%; Screen Size: 17/18; Shelf Life: 12 Months (Leave blank to hide)"></textarea>
							...
							<div class="col-12">
								...
								<textarea name="applications" class="form-control" rows="3" placeholder="e.g. Specialty Cafés, Commercial Bakeries, Beverage Bottling, Industrial Extraction (Leave blank to hide block)"></textarea>
							...
							<div class="col-md-4">
								...
								<input type="text" name="packaging" class="form-control" placeholder="e.g. 1kg Pouches, 25kg Bags (Leave blank to hide)">
							</div>

							<div class="col-md-4">
								<label class="form-label fw-bold">Minimum Order Quantity - MOQ (Optional)</label>
								<input type="text" name="moq" class="form-control" placeholder="e.g. 25 kg / 1 Metric Ton (Leave blank to hide)">
							</div>
												...
												<div class="mb-2">
													...
													<div class="d-flex align-items-center gap-2 mb-1">
														<div style="width: 36px; height: 36px; background: #f8f9fa; border: 1px solid #e9ecef; border-radius: 6px; display: flex; align-items: center; justify-content: center; padding: 4px; flex-shrink: 0;">
															<img src="../../assets/img/icons/pillar-2-quality.svg" alt="" style="max-width: 100%; max-height: 100%; object-fit: contain;">
														</div>
														<input type="file" name="badge1_icon" class="form-control form-control-sm" accept="image/*,.svg">
													</div>
													<small class="text-muted" style="font-size: 11px;">Upload PNG, SVG, or JPG icon (default SVG used if empty).</small>
												</div>
												<label class="form-label small fw-semibold">Title</label>
												<input type="text" name="badge1_title" class="form-control form-control-sm mb-2" value="Batch Verified" placeholder="e.g. Batch Verified">
												<label class="form-label small fw-semibold">Description</label>
												<textarea name="badge1_desc" class="form-control form-control-sm no-ckeditor" data-no-ckeditor="true" rows="3" placeholder="e.g. Strict QA check on moisture, grading &amp; packaging.">Strict QA check on moisture, grading &amp; packaging.</textarea>
											</div>
										</div>
										<div class="col-md-4">
											<div class="bg-white p-3 rounded border h-100">
												...
												<div class="mb-2">
													...
													<div class="d-flex align-items-center gap-2 mb-1">
														<div style="width: 36px; height: 36px; background: #f8f9fa; border: 1px solid #e9ecef; border-radius: 6px; display: flex; align-items: center; justify-content: center; padding: 4px; flex-shrink: 0;">
															<img src="../../assets/img/icons/pillar-3-logistics.svg" alt="" style="max-width: 100%; max-height: 100%; object-fit: contain;">
														</div>
												...
												<label class="form-label small fw-semibold">Title</label>
												<input type="text" name="badge2_title" class="form-control form-control-sm mb-2" value="Dependable Logistics" placeholder="e.g. Dependable Logistics">
												<label class="form-label small fw-semibold">Description</label>
												<textarea name="badge2_desc" class="form-control form-control-sm no-ckeditor" data-no-ckeditor="true" rows="3" placeholder="e.g. Timely port freight &amp; domestic dispatch.">Timely port freight &amp; domestic dispatch.</textarea>
											</div>
										</div>
										<div class="col-md-4">
											<div class="bg-white p-3 rounded border h-100">
												...
												<div class="mb-2">
													...
													<div class="d-flex align-items-center gap-2 mb-1">
														<div style="width: 36px; height: 36px; background: #f8f9fa; border: 1px solid #e9ecef; border-radius: 6px; display: flex; align-items: center; justify-content: center; padding: 4px; flex-shrink: 0;">
															<img src="../../assets/img/icons/partnership-trust.svg" alt="" style="max-width: 100%; max-height: 100%; object-fit: contain;">
														</div>
												...
												<label class="form-label small fw-semibold">Title</label>
												<input type="text" name="badge3_title" class="form-control form-control-sm mb-2" value="Commercial Pricing" placeholder="e.g. Commercial Pricing">
												<label class="form-label small fw-semibold">Description</label>
												<textarea name="badge3_desc" class="form-control form-control-sm no-ckeditor" data-no-ckeditor="true" rows="3" placeholder="e.g. Competitive volume rates for long-term partners.">Competitive volume rates for long-term partners.</textarea>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="col-md-6">
								...
								<small class="text-muted">High resolution JPG or PNG</small>
							</div>

							<div class="col-md-6">
								<label class="form-label fw-bold">Header Background Image (Optional)</label>
							...
							<div class="col-12 mt-4">
								<button type="submit" name="add_product" class="btn btn-antara-gold px-4 py-2">
