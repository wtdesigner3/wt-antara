                     ...
                     <form name="myform" method="post" action=""> 
						...
						<div class="alert alert-secondary fade show">
							...
							<div class="btn-group btn-group-justified">
                              <a href="add-service-category.php" class="btn btn-default active"><i class="fa fa-plus"></i> Add New Service</a>
							...
							<table id="data-table-responsive" class="table table-striped table-bordered">
								<thead>
									<tr>
										...
										<th class="text-nowrap">Service Title</th>
										<th class="text-nowrap">Service slug</th>
			                    ...
			                    ?>
									<tr class="odd gradeX">
										...
										<td width="1%" class="with-img"><img src="../uploads/service/<?php echo $web['main_image']; ?>" class="img-rounded height-60" /></td>
