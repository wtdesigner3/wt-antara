                     ...
                     <form name="myform" method="post" action=""> 
						...
						<div class="alert alert-secondary fade show">
							...
							<div class="btn-group btn-group-justified">
                              <a href="add-service.php" class="btn btn-default active"><i class="fa fa-plus"></i> Add New Project</a>
							...
							<table id="data-table-responsive" class="table table-striped table-bordered">
								<thead>
									<tr>
										...
										<th class="text-nowrap">Architect</th>
			                    ...
			                    ?>
									<tr class="odd gradeX">
									   ...
									   <td style="font-weight:700; color:#000;"><?= $web['architect'];?></td>
									   <td style="font-weight:700; color:#000;"><?= $web['client'];?></td>
									   <td style="font-weight:700; color:#000;"><?= $web['term'];?></td>
