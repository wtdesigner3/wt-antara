                                    ...
                                    <?php foreach ($related_products as $rel): ?>
                                        <div class="swiper-slide">
                                            <div class="b2b-product-card">
                                                ...
                                                <a href="<?= get_product_url($rel) ?>" class="b2b-card-circle-btn" title="View Specifications">
                                                    <i class="fa-solid fa-arrow-up-right-from-square"></i>
                                                </a>
                                                <div class="b2b-card-glass-bottom">
                                                    <h3 class="b2b-card-glass-title">
                                                        <a href="<?= get_product_url($rel) ?>"><?= clean_output($rel['name']) ?></a>
                                                    </h3>
                                                    ...
                                                    <a href="<?= get_product_url($rel) ?>" class="b2b-btn-white-pill">
