                    ...
                    <div class="b2b-industry-card">
                        ...
                        <?php if (!empty(trim($about['ind1_btn_text'] ?? ''))): ?>
                            <div class="mt-auto pt-3">
                                <a href="<?= clean_output(!empty($about['ind1_btn_link']) ? $about['ind1_btn_link'] : 'product-detail.php?slug=product-arabica') ?>" class="theme-btn btn-sm">
                ...
                <div class="<?= $ind_col ?>" data-aos="fade-up" data-aos-delay="200">
                    <div class="b2b-industry-card">
                        ...
                        <?php if (!empty(trim($about['ind2_btn_text'] ?? ''))): ?>
                            <div class="mt-auto pt-3">
                                <a href="<?= clean_output(!empty($about['ind2_btn_link']) ? $about['ind2_btn_link'] : 'supply-coffee.php') ?>" class="theme-btn gold-btn btn-sm">
        ...
        <div class="row align-items-center g-5">
            <div class="<?= $cap_text_col ?>">
                ...
                <?php if ($has_cap_btn1 || $has_cap_btn2): ?>
                    <div class="d-flex flex-wrap gap-3">
                        <?php if ($has_cap_btn1): ?>
                            <a href="<?= clean_output(!empty($about['capabilities_btn1_link']) ? $about['capabilities_btn1_link'] : 'product-detail.php?slug=product-arabica') ?>" class="theme-btn">
                                <?= clean_output($about['capabilities_btn1_text']) ?> <i class="fa-solid fa-arrow-right ms-1"></i>
                            </a>
                        <?php endif; ?>
                        <?php if ($has_cap_btn2): ?>
                            <a href="<?= clean_output(!empty($about['capabilities_btn2_link']) ? $about['capabilities_btn2_link'] : 'product-detail.php?slug=supply-coffee') ?>" class="theme-btn border-btn text-dark" style="border-color: var(--theme); color: var(--theme) !important;">
